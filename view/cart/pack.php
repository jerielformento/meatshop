...
<div class="row">
  <div class="col-md-3" style="height:175px;">
    ...
    <a class="active" href="#"><i class="fas fa-shopping-bag"></i> To Pack</a>
    <a href="/cart/ship"><i class="fas fa-shipping-fast"></i> To Ship</a>
    <a href="/cart/complete"><i class="fas fa-receipt"></i> Completed</a>
    </div>
  </div>
  <div class="col-md-9">
    <p class="text-danger"><strong>To Pack Orders</strong> <button class="btn btn-sm btn-danger pull-right my-2 my-sm-0 mr-1 mb-1" type="submit" disabled><i class="fa fa-ban"></i> Cancel Order</button></p>
