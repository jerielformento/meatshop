...
<div class="row">
  <div class="col-md-3" style="height:175px;">
    ...
    <a class="active" href="#"><i class="fas fa-receipt"></i> Completed</a>
    </div>
  </div>
  <div class="col-md-9">
    <div class="table-responsive">
        <p class="text-danger"><strong>Completed Orders</strong></p>
        <table class="table table-condensed mt-3">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="max-width:170px;">02/03/2022</td>
                    <td style="max-width:170px;">GCash</td>
                </tr>
                <tr>
                    ...
                    <td style="max-width:170px;">02/03/2022</td>
                    <td style="max-width:170px;">Cash on Delivery</td>
                </tr>
            </tbody>
        </table>
    </div><hr/>
