	...
	<div class="col-xl-12 col-lg-11">
	  <div class="card shadow mb-4">
		...
		<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
		  <h6 class="m-0 font-weight-bold text-gray-600"><span class="fa fa-fw fa-user-plus fa-lg"></span> Add New User</h6>
		</div>
		<!-- Card Body -->
		<div class="card-body">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <?php
                            ...
                            $form->field(array(
                                ...
                                'require'=>1,
                                'value'=>$this->saveData('confirm_password')
                            ));
                            $form->field(array(
                                'type'=>'text',
                                'name'=>'email_address',
